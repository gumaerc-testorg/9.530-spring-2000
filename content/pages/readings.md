---
content_type: page
description: Reading for the course.
draft: false
...
---
The readings listed below are the foundation of this course. Where available, journal article abstracts from {{% resource_link "2c7568b8-1b93-4aac-8a87-9d0beb436d8f" "PubMed" %}} (an online database providing access to citations from biomedical literature) are included.
...
Gold, L, et al. "{{% resource_link "bf98c1ea-89d7-4c4c-96a5-440821a659b9" "From Oligonucleotide Shapes to Genomic SELEX: Novel Biological Regulatory Loops" %}}." *Proc. Natl. Acad. Sci. USA* 94 (1997): 59-64.
...
Spiegelman, S. "{{% resource_link "1350cbed-90ab-43c0-b2d4-44f645b49e92" "An Approach to the Experimental Analysis of Precellular Evolution" %}}." *Q. Rev. Biophys*. 4 (1971): 213-53.
...
Adleman, L. M. "{{% resource_link "dc85cf34-f016-4442-94ad-5366a0437049" "Molecular Computation of Solutions to Combinatorial Problems" %}}." *Science* 266(5187) (11 Nov 1994): 1021-4.
...
E, Winfree, Liu F, Wenzler LA, and Seeman NC. "{{% resource_link "602808a5-3aa3-4cb1-84bd-772352f2dabb" "Design and Self-Assembly of Two Dimensional DNA Crystals" %}}." *Nature* 394(6693) (6 Aug 1998): 539-44.
...
Fell, D. A. "{{% resource_link "eab60619-14de-4f78-9c9a-97e0d01758a3" "Metabolic Control Analysis: A Survey of its Theoretical and Experimental Development" %}}." *Biochem. J.* 286 (1992): 313-30.
...
Magnasco, M. O. "{{% resource_link "507f712d-5325-4c82-932a-d2ee9508e79b" "Chemical Kinetics is Turing Universal" %}}." *Phys. Rev. Lett.* 78 (1997): 1190-3.
...
Elowitz, M., and S. Leibler. "{{% resource_link "68855906-c0b3-4637-b511-c6702f4f52fa" "A Synthetic Oscillatory Network of Transcriptional Regulators" %}}." *Nature* 403 (2000): 335-338.
...
Gardner, T. S., C. R. Cantor, and J. J. Collins. "{{% resource_link "01811d78-6e04-4b4c-8e48-bb853cf619ac" "Construction of a Genetic Toggle Switch In Escherichia Coli" %}}." *Nature* 403 (2000): 339-342.
...
Lutz, R., and H. Bujard. "{{% resource_link "291a2060-393d-4784-b5e8-16f8ac1e0b77" "Independent and Tight Regulation of Transcriptional Units in Escherichia Coli via the LacR/O, the TetR/O and AraC/I1-I2 Regulatory Elements" %}}." *Nucleic Acids Res*. 25 (1997): 1203-10.
...
Ermentrout, B. "{{% resource_link "2679162a-1f58-4e46-a9d9-88706c145cc1" "Linearization of F-I Curves by Adaptation" %}}." *Neural Comput.* 10 (1998): 1721-9.
...
Alon, U., M. G. Surette, N. Barkai, and S. Leibler. "{{% resource_link "7d2dc8f8-c59c-4a44-8bc8-1522779d1b3e" "Robustness in Bacterial Chemotaxis" %}}." *Nature* 397 (1999): 168-71.
...
Barkai, N., and S. Leibler. "{{% resource_link "20ddc353-f168-4eda-a57e-98d2e0f07191" "Robustness in Simple Biochemical Networks" %}}." *Nature* 387 (1997): 913-7.
...
Bray, D., M. D. Levin, and C. J. Morton-Firth. "{{% resource_link "5ea4df30-b710-4717-a538-18ed09d50237" "Receptor Clustering as a Cellular Mechanism to Control Sensitivity" %}}." *Nature* 393 (1998): 85-8.
...
Bray, D., R. B. Bourret, and M. I. Simon. "{{% resource_link "1abb0a95-f401-4a62-9d9e-01f58a885913" "Computer Simulation of the Phosphorylation Cascade Controlling Bacterial Chemotaxis" %}}." *Mol. Biol. Cell.* 4 (1993): 469-82.
...
Dubnau, J., and T. Tully. "{{% resource_link "f256fbc8-66cf-4efd-a410-15c985c8c3ce" "Gene Discovery in Drosophila: New Insights For Learning and Memory" %}}." *Annu. Rev. Neurosci.* 21 (1998): 407-44.
...
Malenka, R. C., and R. A. Nicoll. "{{% resource_link "c7eb5c4b-25c2-4618-9942-88ef40b14436" "Long-term Potentiation---A Decade of Progress?" %}}" *Science* 285 (1999): 1870-74.
...
Lisman, J. "{{% resource_link "bf05cc5d-d680-4be5-9dd4-82b02711e2fa" "A Mechanism for the Hebb and the Anti-Hebb Processes Underlying Learning and Memory" %}}." *Proc. Natl. Acad. Sci. USA* 86 (1989): 9574-78.
...
\---. "{{% resource_link "591a53fa-6a9f-4714-b0b0-9cf9d2548370" "A Mechanism for Memory Storage Insensitive to Molecular Turnover: A Bistable Autophosphorylating Kinase" %}}." *Proc. Natl. Acad. Sci. USA* 82 (1985): 3055-7.
...
\---. "{{% resource_link "2bb56e21-d1b7-4012-bb75-9c718ea20f59" "The CaM kinase II Hypothesis for the Storage of Synaptic Memory" %}}." *Trends Neurosci*. 17 (1994): 406-12.
...
Lisman, J., and M. A. Goldring. "{{% resource_link "d5338e6b-7f7b-4a6f-9a44-40ead8d96db7" "Feasibility of Long-term Storage of Graded Information by the Ca2+/calmodulin-dependent Protein Kinase Molecules of the Postsynaptic Density" %}}." *Proc. Natl. Acad. Sci. USA* 85 (1988): 5320-4.
...
Bhalla, U. S., and R. Iyengar. "{{% resource_link "57ac7a00-690f-459b-a550-06439d740f0f" "Emergent Properties of Networks of Biological Signaling Pathways" %}}." *Science* 283 (1999): 381-7.
...
Squire and Kandel. *Memory: From Mind to Molecules*. Scientific American Library\_.\_ 1999, chap.7.

### Circadian Rhythms

Barkai, N. and S. Leibler. "{{% resource_link "01be083c-97c8-405f-9cc0-67dca5489022" "Circadian Clocks Limited by Noise" %}}." *Nature* 403 (2000): 267-8.

Dunlap, J. C. "{{% resource_link "1c066211-e2c5-4d85-9dc4-0a05da2795f5" "Molecular Bases for Circadian Clocks" %}}." *Cell.* 96 (1999): 271-90.

Glossop, N. R. J., L. C. Lyons, and P. E. Hardin. "{{% resource_link "6edf347a-c305-4b68-9696-a8672d3fbeb9" "Interlocked Feedback Loops Within The Drosophila Circadian Oscillator" %}}." *Science* 286 (1999): 766-8.
...
Johnson and Golden. "{{% resource_link "5a322c60-cd9f-44ba-813d-286a0da66ce5" "Circadian Programs in Cyanobacteria: Adaptiveness and Mechanism" %}}" *Annu. Rev. Microbiol.* 53(1999): 389-409.
...
Tyson, et al. "{{% resource_link "cf0cef84-c28f-4554-ae9f-ef83b34e65ff" "A Simple Model of Circadian Rhythms Based on Dimerization and Proteolysis of PER and TIM" %}}." *Biophys J.* 77 (1999): 2411-7.
...
Arkin, A., J. Ross, and H. H. McAdams. "{{% resource_link "8661c4af-7c4e-4b80-99e9-0758c27b99d2" "Stochastic Kinetic Analysis of Developmental Pathway Bifurcation in Phage ?-infected. Escherichia Coli Cells" %}}." *Genetics* 149 (1998): 1633-48.
...
McAdams, H. H., and A. Arkin. "{{% resource_link "c50af605-7188-46c7-a5a3-bc2edebe25a3" "Stochastic Mechanisms in Gene Expression" %}}." *Proc. Natl. Acad. Sci. USA* 94 (1997): 814-9.
...
Howard, J. "{{% resource_link "1552eb08-deac-4bc9-ac95-f348517d609e" "Molecular Motors: Structural Adaptations to Cellular Functions" %}}." *Nature* 389 (1997): 561-6.
...
Mehta, A. D., M. Rief, J. A. Spudich, D. A. Smith, and R. M. Simmons. "{{% resource_link "21224e16-076a-4024-b808-86cff913f11b" "Single-molecule Biomechanics With Optical Methods" %}}." *Science* 283 (1999): 1689-95.
...
Reinitz, J., D. Kosman, C. E. Vanario-Alonso, and D. H. Sharp. "{{% resource_link "b85f784f-e462-4b36-ab0a-aa70d34159d3" "Stripe Forming Architecture of the Gap Gene System" %}}." *Dev. Genetics* 23 (1998): 11-27.
...
Stanojevic, D., S. Small, and M. Levine. "{{% resource_link "46edb30e-ae67-48b2-9d8b-650a57ef25a0" "Regulation of a Segmentation Stripe by Overlapping Activators and Repressors in the Drosophilia Embryo" %}}." *Science* 254 (1991): 1385-1387.
...
Wolpert, L. "{{% resource_link "ac679123-3f61-4deb-8a8b-a84b5d5d8637" "Positional Information and Pattern Formation in Development" %}}." *Dev. Genetics* 15 (1994): 485-490.
...
Lawrence, P. A. "{{% resource_link "3377f2bc-925a-4c4c-be16-aa1946a47362" "The Making of a Fly: The Genetics of Animal Design" %}}." *Blackwell* (1992).

### Cell Cycle

Gardner, T., M. Dolnik, and J. J. Collins. "{{% resource_link "c27bbd00-9e84-4bd1-adbb-47e905b81c95" "A Theory for Controlling Cell Cycle Dynamics Using a Reversibly Binding Inhibitor" %}}." *Proc. Natl. Acad. Sci. USA* 95 (1998): 14190-95.

Goldbeter, A. "{{% resource_link "c9f0ad79-150a-4a30-9cd0-aec03b7e3472" "A Minimal Cascade Model for the Mitotic Oscillator Involving Cyclin and cdc2 Kinase" %}}." *Proc. Natl. Acad. Sci. USA* 88 (1991): 9107-9111.
...
Novak, B. and J. J. Tyson. "{{% resource_link "ae40a559-2d07-41c5-91bb-98c1f4bbce09" "Modeling the Control of DNA Replication in Fission Yeast" %}}." *Proc. Natl. Acad. Sci. USA* 94 (1997): 9147-52.
...
Kessler, D. A., and H. Levine. "{{% resource_link "6b0b263e-48f5-4df3-bf13-26e4c0deac46" "Pattern Formation in Dictyostelium via the Dynamics of Cooperative Biological Entities" %}}." *Phys. Rev*. E48 (1993):4801-4.

Levine, H., I. Aranson, L. Tsimring, and T. V. Truong. "{{% resource_link "c0444f63-4e87-4342-9aac-876f5ea31a76" "Positive Genetic Feedback Governs cAMP Spiral Wave Formation in Dictyostelium" %}}." *Proc. Natl. Acad. Sci. USA* 93 (1996): 6382-6.
...
The {{% resource_link "1e9ab022-542b-4b77-8e1f-8d0df78ae135" "Dictyostelium Virtual Library" %}}.

### Cell Sorting

Glazier, J. A., and F. Graner. "{{% resource_link "c4ec2fc6-975b-476a-970a-6fc5841d5cac" "Simulation of the Differential Adhesion Driven Rearrangement of Biological Cells" %}}." *Phys. Rev.* E47 (1993): 2128-54.

Graner, F., and J. A. Glazier. "{{% resource_link "71e11955-99a7-4e6d-b566-712525b5041f" "Simulation of Biological Cell Sorting Using a Two Dimensional Extended Potts model" %}}." *Phys. Rev. Lett.* 69 (1992): 2013-6.

Kataoka, N., K. Saito, and Y. Sawada. "NMR Microimaging of the Cell Sorting Process." *Phys. Rev. Lett.* 82 (1999): 1075.

Steinberg, M. S. "{{% resource_link "929457f9-7447-4440-a593-16715908fb17" "Reconstruction of Tissues by Dissociated Cells." %}}" *Science*, 141, no. 3579 (1963): 401-408.

### Immunity

Herz, A. V. M., S. Bonhoeffer, R. M. Anderson, R. M. May, and M. A. Nowak. "{{% resource_link "3af2c7fc-31ee-4ace-b5a6-f191f8dcfd0b" "Viral Dynamics in Vivo: Limitations on Estimates of Intracellular Delay and Virus Decay" %}}." *Proc. Natl. Acad. Sci. USA* 93 (1996): 7247-51.
...
Ho, D. D., et al. "{{% resource_link "5449cf9b-1743-4c94-b1bf-bab4521192ab" "Rapid Turnover of Plasma Virions and CD4 Lymphocytes in HIV-1 Infection" %}}." *Nature* 373 (1995):123-126.
...
Wei, Xiping, et al. "{{% resource_link "c900657a-9737-420c-94a6-81f367f1508f" "Viral Dynamics in Human Immunodeficiency Virus Type 1 Infection" %}}." *Nature* 373:117-122 (1995).
